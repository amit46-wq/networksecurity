...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric):
        ...
        with mlflow.start_run():
            ...
            # Log artifacts ONLY if they exist
            ...
            if os.path.exists(self.model_trainer_config.trained_model_file_path):
                mlflow.log_artifact(self.model_trainer_config.trained_model_file_path, artifact_path="trained_model")
            
            if os.path.exists("final_model/model.pkl"):
                mlflow.log_artifact("final_model/model.pkl", artifact_path="final_model")
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        print("Test Metrics:")
        print(f"Accuracy:  {classification_test_metric.accuracy:.4f}")
        ...
        # FIXED: Correct class instantiation (NetworkModel instead of Network_Model)
    ...
    # NOW call track_mlflow AFTER files are saved
        self.track_mlflow(best_model, classification_test_metric)  # Use test metrics for tracking
